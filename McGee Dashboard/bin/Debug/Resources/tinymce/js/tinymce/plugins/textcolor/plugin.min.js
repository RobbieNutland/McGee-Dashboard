!function () {
	...
	var pluginManager = tinymce.util.Tools.resolve("tinymce.PluginManager"),
		...
		GetSelectionColour = function (editor, formatName) {
			...
			var globalColour;
            return editor.dom.getParents(editor.selection.getStart(), function (domSelectionNode /*dom object passed from getParents*/) {
		...
		CreateColourMapTable = function (colourColumns, colourRows, colourMap, colourPickerCallbackExistsBool) {
			...
			var colourMapWithTransparency,
				...
				CreateColourTableCell = function (colourCode, colourName) {
					...
					return '<td class="mce-grid-cell' + (isColourCodeTransparentBool ? " mce-colorbtn-trans" : "") + '"><div id="' + elementId + "-" + elementIdNumber++ + '" data-mce-color="' + (colourCode || "") + '" role="option" tabIndex="-1" style="' + (colourCode ? "background-color: " + colourCode : "") + '" title="' + tinymceI18n.translate(colourName) + '">' + (isColourCodeTransparentBool ? "&#215;" : "") + "</div></td>"
				};
		...
		AddButtonsToEditor = function (editor) {
			...
			editor.addButton("bodycolour", { type: "colorbutton", tooltip: "Body Background Colour", image:"Bucket Icon.png", format: "hilitecolor", panel: { role: "application", ariaRemember: !0, html: GetColourTableInfo(editor, 3), onclick: ColourCellClicked(editor, GetBodycolourColumns(editor), !1) }, onclick: ButtonClicked(editor, !1) })
		};
